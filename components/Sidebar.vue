...
const sidebarItems = [
  ...
  { label: 'Tournois', icon: 'M3 3h5v6H3m5-3h7v12H8m7-6h7M3 15h5v6H3', link: '#' },
...
<template>
  ...
  <div class="app-sidebar w-40">
    <div v-for="(item, index) in sidebarItems" :key="index"
      class="flex flex-row justify-start items-center w-full py-2 hover:bg-gray-400 hover:rounded dark:hover:bg-gray-600">
